...
const Button = ({ path, text }) => {
  ...
  return (
    <Link to={path}>
        <button className="relative inline-flex items-center justify-start mx-3 md:mx-0 py-3 px-4 md:px-6 md:py-3 overflow-hidden font-medium transition-all bg-gray-200 rounded hover:bg-white group ">
